...
New SEL tokens enter into circulation via inflation then distribute in a form of reward to validators and stakers for helping to secure and navigate the network. Inflation is set to be between 0.25% - 2.5% per year, with initial supply starting of 527,922,923 SEL.
...
With an average inflation of 1.5% per year and the initial supply of 527,922,923 SEL, it will take 120 years to reach 3,145,998,227 SEL. 
...
<Authors>
  <Author name="Selendra" link="https://github.com/selendra" />
</Authors>
